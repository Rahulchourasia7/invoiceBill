...
<label htmlFor="quantity">Quantity</label>
      <input type="text" name='quantity' id='quantity' placeholder='Quantity' value={quantity}
...
<button type='submit'
className=" mb-5 bg-blue-500 text-white font-bold py-2 px-8 rounded shadow border-2 border-blue-500 hover:bg-transparent hover:text-blue-500
...
<div>
  <h2 className='flex iems-end justify-end text-gray-800 text-4xl'> Rs. {total}</h2>
</div> 
    </>
